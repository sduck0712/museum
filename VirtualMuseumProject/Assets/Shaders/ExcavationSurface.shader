...
// 4) Lerp(A=ArtifactAlbedo, B=DirtAlbedo, T=blend) -> Base Color 입력
...
Shader "VirtualMuseum/ExcavationSurface"
{
    ...
    SubShader
    {
        ...
        void surf(Input IN, inout SurfaceOutputStandard o)
        {
            ...
            o.Albedo = lerp(artifactColor, dirtColor, blend);
